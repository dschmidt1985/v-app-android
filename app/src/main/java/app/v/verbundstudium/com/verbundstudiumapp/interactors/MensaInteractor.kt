...
interface MensaInteractor {
    ...
    fun loadMenu(mensaType: MensaType, dateTime: DateTime): Observable<List<Dish>>

}

@Singleton
class BaseMensaInteractor @Inject constructor(private val mensaRepo: MensaRepository) : MensaInteractor {
    override fun loadMenu(mensaType: MensaType, dateTime: DateTime): Observable<List<Dish>> {
